...
export function IdUploadForm({ setCurrentStep }: { setCurrentStep: (v:string) => void }) {
    ...
    <div className="space-y-8 p-3" dir="rtl">
      <Card className="p-8 border-1 bg-card">
        <div className="space-y-8">
          {/* Front ID Upload */}
          <div>
            <h2 className="text-md font-bold  text-red-600 mb-4">الخطوة 1: رفع الجانب الأمامي للهوية</h2>
            <p className="text-foreground mb-4">قم برفع صورة واضحة للجانب الأمامي من وثيقة الهوية</p>
                ...
                <div className="flex flex-col items-center gap-2">
                  {isUploadingFront ? (
                    ...
                    <>
                      ...
                      <span className="text-gray-600 font-semibold">تم رفع الجانب الأمامي</span>
                    </>
                  ) : (
                    <>
                      <Upload className="w-8 h-8 text-red-600" />
                      <span className=" text-gray-600 font-semibold">انقر لرفع الجانب الأمامي</span>
                    </>
                  )}
                </div>
              </label>
          ...
          {/* Back ID Upload */}
          <div>
            <h2 className="text-md font-bold text-red-600 mb-4">الخطوة 2: رفع الجانب الخلفي للهوية</h2>
            <p className="text-foreground mb-4">قم برفع صورة واضحة للجانب الخلفي من وثيقة الهوية</p>
              ...
              >
                ...
                <div className="flex flex-col items-center gap-2">
                  {isUploadingBack ? (
                    ...
                    <>
                      <CheckCircle2 className="w-8 h-8 text-primary" />
                      <span className="text-gray-600 font-semibold">تم رفع الجانب الخلفي</span>
                    </>
                  ) : (
                    <>
                      <Upload className="w-8 h-8 text-red-600" />
                      <span className="text-gray-600 font-semibold">انقر لرفع الجانب الخلفي</span>
                    </>
                  )}
                </div>
              </label>
          ...
          {(frontImage || backImage) && (
            ...
            <Button onClick={handleNext } className="w-full bg-red-600 ">
                التالي
            </Button>
        </CardFooter>
          )}
